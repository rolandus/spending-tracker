...
- [x] Category assignment UI (inline badge click + bulk-assign by description pattern)
- [x] Spending reports (monthly by category, payment method breakdown)
- [x] Merchant normalization table with pattern matching
- [x] Transaction detail/edit view
